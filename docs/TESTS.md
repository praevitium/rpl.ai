...
`node tests/test-all.mjs` currently reports **ALL TESTS PASSED (7999)** —
...
| test-matrix-editor.mjs      |   17 | 0    | Matrix-writer grid helpers.        |
| test-numerics.mjs           |  877 | 0    |                                    |
| test-op-search.mjs          |   83 | 0    |                                    |
| test-plot-engine.mjs        |   46 | 0    | Graph sampling / plot ops hook.    |
...
| **test-all (aggregate)**    | **7999** | **0** | Fully green.                 |
