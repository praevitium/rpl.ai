...
`node tests/test-all.mjs` currently reports **ALL TESTS PASSED (8047)** —
...
| test-matrix-editor.mjs      |   36 | 0    | Matrix-writer grid helpers.        |
...
| **test-all (aggregate)**    | **8047** | **0** | Fully green.                 |
